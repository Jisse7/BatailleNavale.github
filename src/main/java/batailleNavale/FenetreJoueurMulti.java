...
public class FenetreJoueurMulti extends JFrame implements Serializable{

	private JPanel contentPane;
	private GrilleGraphiqueMulti grilleTirs;
	private GrilleNavaleGraphiqueMulti grilleDefense;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				try {
					FenetreJoueurMulti frame = new FenetreJoueurMulti();
	 ...
	 * Create the frame.
	 */
	public FenetreJoueurMulti() {
		this("Nom du joueur", 10);
	}

	public FenetreJoueurMulti(String nom, int taille) {
		this(nom,taille,new int[] {1,2,3,4});
	}

	public FenetreJoueurMulti(String nom, int taille, int[] placement) {
		setTitle("Centre naval de "+ nom);
		this.grilleTirs = new GrilleGraphiqueMulti(taille);
		this.grilleDefense = new GrilleNavaleGraphiqueMulti(taille);
	...
	public GrilleGraphiqueMulti getGrilleTirs() {
		return this.grilleTirs;
	}
	public GrilleNavaleGraphiqueMulti getGrilleDefense() {
